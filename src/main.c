...
int Menu_Main(void)
{
    ...
    OSScreenFlipBuffersEx(1);
		...
		console_printf("FTPiiU-Mod v0.1 is listening on %u.%u.%u.%u:%i", (network_gethostip() >> 24) & 0xFF, (network_gethostip() >> 16) & 0xFF, (network_gethostip() >> 8) & 0xFF, (network_gethostip() >> 0) & 0xFF, PORT);
